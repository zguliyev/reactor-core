 ...
 * @author David Karnok
 */
abstract class QueueDrainSubscriber<T, U, V> implements InnerOperator<T, V> {

	static final AtomicLongFieldUpdater<QueueDrainSubscriber> REQUESTED =
			AtomicLongFieldUpdater.newUpdater(QueueDrainSubscriber.class, "requested");
